...
> Snapshot 1
    ...
    ␊
      <head>␊
        ...
        <link rel="apple-touch-icon" sizes="152x152" href="http://localhost:3000/img/apple-touch-icon.png">␊
        <link rel="icon" type="image/png" href="http://localhost:3000/img/favicon-32x32.png" sizes="32x32">␊
        <link rel="icon" type="image/png" href="http://localhost:3000/img/favicon-16x16.png" sizes="16x16">␊
        ...
        <link rel="image_src" type="image/png" href="http://localhost:3000/img/social.png">␊
    ...
    ␊
      <body class="d-flex flex-column h-100" role="document">␊
          ...
          <div class="modal-dialog" role="document">␊
            <div class="modal-content">␊
              ...
              <div class="modal-body">␊
                <div class="container">␊
                  <div>␊
                    <form class="ajax-form" action="/en/register?redirect_to=/en/dashboard" method="POST">␊
                    ...
                    <div class="alert alert-light border mt-3 text-center mb-0">Already have an account? <a class="card-link" href="/en/login" data-dismiss-modal="true" data-toggle="modal-anchor" data-target="#modal-sign-in">Sign in</a>␊
                      <p class="mt-3 mb-0 text-center"><small class="text-black-50">Read our <a href="/en/privacy" target="_blank" rel="noopener">Privacy Policy</a> and <a href="/en/terms" target="_blank" rel="noopener">Terms</a></small></p>␊
                    </div>␊
                  </div>␊
                </div>␊
              </div>␊
          ...
          <div class="modal-dialog" role="document">␊
            <div class="modal-content">␊
              ...
              <div class="modal-body">␊
                <div class="container">␊
                  <div>␊
                    <form class="ajax-form" action="/en/login?redirect_to=/en/dashboard" method="POST">␊
                      <input type="hidden" name="_csrf">␊
                      <div class="form-group floating-label">␊
                    ...
                    <div class="alert alert-light border mt-3 text-center mb-0">Don't have an account? <a class="card-link" href="/en/register" data-dismiss-modal="true" data-toggle="modal-anchor" data-target="#modal-sign-up">Sign up</a>␊
                    </div>␊
                  </div>␊
                </div>␊
              </div>␊
        ...
        <main class="flex-shrink-0" role="main"></main>␊
        ...
        <script>␊
          window.USER = {␊
            id: "4D6wZIuZ9uXECyqM6t2P9d0TS92UH26P"␊
          };␊
        </script>␊
        <script src="http://localhost:3000/js/factor-bundle.js" crossorigin="anonymous"></script>␊
        <script src="http://localhost:3000/js/uncaught.js" crossorigin="anonymous"></script>␊
        <script src="http://localhost:3000/js/core.js" crossorigin="anonymous"></script>␊
      </body>␊
    ␊
    </html>`
...
> Snapshot 1
    ...
    ␊
      <body class="d-flex flex-column h-100" role="document">␊
        ...
        <script>␊
          window.USER = {␊
            id: "zjXK8yev_nEvZpWoYzMAURWXmboFPCmE"␊
          };␊
        </script>␊
        <script src="http://localhost:3000/js/factor-bundle.js" crossorigin="anonymous"></script>␊
        <script src="http://localhost:3000/js/uncaught.js" crossorigin="anonymous"></script>␊
...
> Snapshot 1
    ...
    ␊
      <body class="d-flex flex-column h-100" role="document">␊
          ...
          <div class="modal-dialog" role="document">␊
            <div class="modal-content">␊
              ...
              <div class="modal-body">␊
                <div class="container">␊
                  <div>␊
                    <form class="ajax-form" action="/es/register?redirect_to=/es/dashboard" method="POST">␊
                      <input type="hidden" name="_csrf">␊
                      <div class="form-group floating-label">␊
                        <input class="form-control form-control-lg" id="input-email-sign-up" type="email" required name="email" placeholder="name@example.com" autocomplete="email">␊
                        <label for="input-email-sign-up">Email address</label>␊
                    ...
                    <div class="alert alert-light border mt-3 text-center mb-0">Already have an account? <a class="card-link" href="/es/login" data-dismiss-modal="true" data-toggle="modal-anchor" data-target="#modal-sign-in">Sign in</a>␊
                      <p class="mt-3 mb-0 text-center"><small class="text-black-50">Read our <a href="/es/privacy" target="_blank" rel="noopener">Privacy Policy</a> and <a href="/es/terms" target="_blank" rel="noopener">Terms</a></small></p>␊
                    </div>␊
                  </div>␊
                </div>␊
              </div>␊
          ...
          <div class="modal-dialog" role="document">␊
            <div class="modal-content">␊
              ...
              <div class="modal-body">␊
                <div class="container">␊
                  <div>␊
                    <form class="ajax-form" action="/es/login?redirect_to=/es/dashboard" method="POST">␊
                      <input type="hidden" name="_csrf">␊
                      <div class="form-group floating-label">␊
                        <input class="form-control form-control-lg" id="input-email-sign-in" type="email" required name="email" placeholder="name@example.com" autocomplete="email">␊
                        <label for="input-email-sign-in">Email address</label>␊
                    ...
                    <div class="alert alert-light border mt-3 text-center mb-0">Don't have an account? <a class="card-link" href="/es/register" data-dismiss-modal="true" data-toggle="modal-anchor" data-target="#modal-sign-up">Sign up</a>␊
                    </div>␊
                  </div>␊
                </div>␊
              </div>␊
        ...
        <script>␊
          window.USER = {␊
            id: "aE6JlziDiyFCAiwBjfkCGZADZfbGTD3e"␊
          };␊
        </script>␊
        <script src="http://localhost:3000/js/factor-bundle.js" crossorigin="anonymous"></script>␊
        <script src="http://localhost:3000/js/uncaught.js" crossorigin="anonymous"></script>␊
...
> Snapshot 1
    ...
    ␊
      <body class="d-flex flex-column h-100" role="document">␊
        ...
        <script>␊
          window.USER = {␊
            id: "tRS6njqq-JssLhOlZi8HNy5ji9FXSgtm"␊
          };␊
        </script>␊
        <script src="http://localhost:3000/js/factor-bundle.js" crossorigin="anonymous"></script>␊
        <script src="http://localhost:3000/js/uncaught.js" crossorigin="anonymous"></script>␊
